...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        data_file = settings.BASE_DIR / 'data' / 'charging_stations.csv'
        keys = ('NOM_PARC', 'ADRESSE', 'LONGITUDE', 'LATITUDE')  # the CSV columns we will gather data from.
